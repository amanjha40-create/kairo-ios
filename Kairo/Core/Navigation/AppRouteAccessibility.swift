...
nonisolated enum KairoAccessibilityID {
    ...
    static let createAccountTerms = "onboarding.createAccount.terms"
    static let createAccountPrivacy = "onboarding.createAccount.privacy"
    ...
    static let verifyIdentityRecoveredSession = "onboarding.verifyIdentity.recoveredSession"
    static let verifyIdentityRecoveryStartOver = "onboarding.verifyIdentity.recoveredSession.startOver"
    ...
    static let passportPDFLoading = "candidate.passport.pdf.loading"
    static let passportPDFError = "candidate.passport.pdf.error"
    static let passportPDFRetry = "candidate.passport.pdf.retry"
    static let passportPDFPreview = "candidate.passport.pdf.preview"
    static let passportPDFShare = "candidate.passport.pdf.share"
    static let passportPDFPreviewFailure = "candidate.passport.pdf.preview.failure"
    static let passportPDFPreviewError = "candidate.passport.pdf.preview.error"
    static let passportPDFPreviewRetry = "candidate.passport.pdf.preview.retry"
    ...
    static let moreDeleteAccountConfirmationInput = "candidate.more.deleteAccount.confirmationInput"
    static let moreDeleteAccountCurrentPassword = "candidate.more.deleteAccount.currentPassword"
    static let moreDeleteAccountFinalButton = "candidate.more.deleteAccount.finalButton"
    static let moreDeleteAccountError = "candidate.more.deleteAccount.error"
    static let moreDeleteAccountSuccess = "candidate.more.deleteAccount.success"
